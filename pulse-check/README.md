...
clawhub install pulse-check

# Or clone manually
cp -r pulse-check/ ~/.openclaw/skills/pulse-check/

# Set your weather API key (free at openweathermap.org)
export OPENWEATHER_API_KEY=your_key_here

# Edit your config
nano ~/.openclaw/skills/pulse-check/pulse-config.json

# Test it
node ~/.openclaw/skills/pulse-check/pulse.js --dry-run
```
