...
4. Choose a name for your bot (e.g., "BlueCollarClaw Bot")
5. Choose a username ending in "_bot" (e.g., "BlueCollarClawBot")
...
- Update the bot as BlueCollarClaw evolves
