# BlueCollarClaw - Technical Architecture
...
BlueCollarClaw/counters/{contractor_id}  # Counter-offers
BlueCollarClaw/accepts/{contractor_id}   # Acceptances
...
```javascript
{
  ...
  startDate: "2026-02-19",
  endDate: "2026-02-21",
  message: "Available at $90/hr. 4.8★ rating, 47 BlueCollarClaw jobs.",
  round: 1,
...
```javascript
{
  ...
  contractUrl: "https://BlueCollarClaw.com/contracts/booking_mno.pdf",
...
The brain of BlueCollarClaw. Evaluates requests and makes decisions.
...
- Digital signatures (BlueCollarClaw acceptance timestamps)
...
```javascript
const event = {
  summary: "BlueCollarClaw: Plumber - Mike's Plumbing",
