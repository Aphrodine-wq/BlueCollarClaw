# 🤝 BlueCollarClaw - Getting Started (2 Minutes)
...
**Time:** 60 seconds  
**Output:** `my-BlueCollarClaw-config.txt` with your contractor ID
...
- ✅ Make sure you're in the BlueCollarClaw directory
...
- ✅ Check `my-BlueCollarClaw-config.txt`
...
3. **Save contractor ID** - It's in `my-BlueCollarClaw-config.txt`
