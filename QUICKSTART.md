# ClawShake - Quick Start

## What You Just Got

A fully functional MVP of the ClawShake protocol:
...
- **ClawShake agent** — The core orchestrator that ties it all together
...
The fastest way to see ClawShake in action (no MQTT broker needed):
...
```
ClawShake/
├── agent.js          # Core ClawShake agent (orchestrates everything)
