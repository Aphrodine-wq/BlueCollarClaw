 ...
 * 
 * Usage with OpenClaw:
 *   Add to OpenClaw config to route messages to ClawShake
 * 
 * Usage standalone:
...
Your request is now live on ClawShake.
...
if (require.main === module) {
  ...
  console.log('=== ClawShake Message Handler Test ===\n');
