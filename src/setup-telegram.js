...
console.log('🤖 BlueCollarClaw Telegram Bot Setup\n');
...
console.log('4. Name your bot: "BlueCollarClaw Bot"');
console.log('5. Username: something like "YourBlueCollarClawBot" (must end in "bot")');
