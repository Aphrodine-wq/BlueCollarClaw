...
async function setup() {
  header('🤝 CLAWSHAKE SETUP WIZARD');

  log('Welcome to ClawShake! Let\'s get you set up in 60 seconds.', 'cyan');
  console.log();
  ...
  console.log();
  log('  💡 Tip: Set a range. ClawShake will auto-negotiate within it.', 'cyan');
  console.log();
  ...
  console.log();
  log('  🤖 ClawShake can auto-respond to job requests for you.', 'cyan');
  console.log();
  ...
  // Generate profile
  log('\n⚙️  Generating your ClawShake profile...', 'yellow');
  ...
  log('Your ClawShake profile is ready:', 'green');
  console.log();
  log(`  👤 Name: ${name}`, 'cyan');
...
`);
  ...
  log('═'.repeat(60), 'cyan');
  log('  Welcome to ClawShake! 🤝', 'green');
  log('═'.repeat(60), 'cyan');
  console.log();
