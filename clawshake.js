...
async function runDemo() {
  console.log();
  log('  🎬 Starting ClawShake demo...', 'green');
  console.log();
...
async function checkStatus() {
  console.log();
  log('  📊 ClawShake System Status', 'bright');
  console.log();
  ...
  db.db.get('SELECT COUNT(*) as count FROM contractors', (err, result) => {
    ...
    db.db.get('SELECT COUNT(*) as count FROM job_requests', (err, result) => {
      ...
      db.db.get('SELECT COUNT(*) as count FROM bookings', (err, result) => {
        ...
        const dbExists = fs.existsSync('./clawshake.db') || fs.existsSync('./demo.db');
        ...
        const configExists = fs.existsSync('./my-clawshake-config.txt');
